...
public class CheckActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		if ((FirebaseAuth.getInstance().getCurrentUser() != null)) {
			done.setClass(getApplicationContext(), MainActivity.class);
			startActivity(done);
			SketchwareUtil.showMessage(getApplicationContext(), "Loged in Successfuly !");
		}
		else {
			SketchwareUtil.showMessage(getApplicationContext(), "Entered Data error !\nEmail or Password");
			finish();
		}
	}
